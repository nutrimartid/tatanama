...
class AddForm(Form):
    ...
    sub = SelectField(validators=[InputRequired("Please insert sub")], render_kw={"placeholder" : "Insert sub"}, id = "sub", choices=[('L-MEN POWDER','L-MEN POWDER'),('L-MEN RTD','L-MEN RTD'),('NS TRADITIONAL','NS TRADITIONAL'),('PAKET NUTRISARI','PAKET NUTRISARI'),('NS MODERN','NS MODERN'),('NS RTD','NS RTD'),('PAKET WDANKTS MERAH','PAKET WDANKTS MERAH'),('TS KUNING OTHERS','TS KUNING OTHERS'),('TS KUNING - SWT POWDER','TS KUNING - SWT POWDER'),('TS BIRU','TS BIRU'),('PAKET TS','PAKET TS'),('DIABETAMIL','DIABETAMIL'),('HILO GOLD','HILO GOLD'),('HILO SCHOOL','HILO SCHOOL'),('HILO TEEN','HILO TEEN'),('HILO ACTIVE','HILO ACTIVE'),('HILO RTD','HILO RTD'),('HILO TRADITIONAL','HILO TRADITIONAL'),('PAKET HILO','PAKET HILO'),('WDANK TRADITIONAL','WDANK TRADITIONAL'),('WRP','WRP'),('HB','HB'),('OTHER','OTHER'),])
